# RHOAI 2.9 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.9
Platform version from: checkouts/red-hat-data-services.rhoai-2.9/rhods-operator
Date: 2026-03-15
...
- **Version**: 2.9
- **Components**: 12
- **Source**: checkouts/red-hat-data-services.rhoai-2.9
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.9
```
