...
### For Developers
- [Component Structure](./odh-dashboard-component.png) ([mmd](./odh-dashboard-component.mmd)) - Mermaid diagram showing internal components (oauth-proxy, backend, frontend, model-registry-ui BFF)
- [Data Flows](./odh-dashboard-dataflow.png) ([mmd](./odh-dashboard-dataflow.mmd)) - Sequence diagram of request/response flows (UI access, K8s API proxy, Model Registry, Prometheus, WebSocket)
- [Dependencies](./odh-dashboard-dependencies.png) ([mmd](./odh-dashboard-dependencies.mmd)) - Component dependency graph (K8s API, OAuth, Notebook Controller, KServe, ModelMesh, etc.)
