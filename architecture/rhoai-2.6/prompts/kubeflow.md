...
Manifests folder: components/odh-notebook-controller/config:odh-notebook-controller/odh-notebook-controller
...
Branch: rhoai-2.6
Remote: https://github.com/red-hat-data-services/kubeflow.git

Recent commits: (none in last 3 months)
