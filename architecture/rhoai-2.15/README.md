# RHOAI 2.15 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.15
Platform version from: checkouts/red-hat-data-services.rhoai-2.15/rhods-operator
Date: 2026-03-15
...
- **Version**: 2.15
- **Components**: 14
- **Source**: checkouts/red-hat-data-services.rhoai-2.15
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.15
```
