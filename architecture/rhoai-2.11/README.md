# RHOAI 2.11 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.11
Platform version from: checkouts/red-hat-data-services.rhoai-2.11/rhods-operator
Date: 2026-03-15
...
- **Version**: 2.11
- **Components**: 13
- **Source**: checkouts/red-hat-data-services.rhoai-2.11
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.11
```
