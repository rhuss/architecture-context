...
Generated from: `architecture/rhoai-2.19/data-science-pipelines.md`
...
```bash
/generate-architecture-diagrams --architecture=architecture/rhoai-2.19/data-science-pipelines.md
```
