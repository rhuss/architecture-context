...
The operator applies the following overlay for RHOAI self-managed: default

Overlay path within source_folder: default
...
params.env values (from prefetched-manifests/codeflare/manager/params.env):
...
kustomization.yaml at config/default/ rather than the base. The overlay
