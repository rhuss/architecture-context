...
The operator applies the following overlay for RHOAI self-managed: https://rhods-dashboard-

Overlay path within source_folder: https://rhods-dashboard-
This means the kustomization.yaml the operator actually processes is at:
  manifests/https://rhods-dashboard-/kustomization.yaml

All overlay paths by platform/name:
  baseConsoleURL:SelfManagedRhoai: https://rhods-dashboard-
  baseConsoleURL:ManagedRhoai: https://rhods-dashboard-
  baseConsoleURL:OpenDataHub: https://odh-dashboard-
...
kustomization.yaml at manifests/https://rhods-dashboard-/ rather than the base. The overlay
