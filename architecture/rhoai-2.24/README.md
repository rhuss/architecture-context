# RHOAI 2.24 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.24
Platform version from: checkouts/red-hat-data-services.rhoai-2.24/rhods-operator
Date: 2026-03-20
...
- **Version**: 2.24
- **Components**: 45
- **Source**: checkouts/red-hat-data-services.rhoai-2.24
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.24
```
