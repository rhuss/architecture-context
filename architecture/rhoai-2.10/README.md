# RHOAI 2.10 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.10
Platform version from: checkouts/red-hat-data-services.rhoai-2.10/rhods-operator
Date: 2026-03-15
...
- **Version**: 2.10
- **Components**: 13
- **Source**: checkouts/red-hat-data-services.rhoai-2.10
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.10
```
