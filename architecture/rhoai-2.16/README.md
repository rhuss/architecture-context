# RHOAI 2.16 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.16
Platform version from: checkouts/red-hat-data-services.rhoai-2.16/rhods-operator
Date: 2026-03-16
...
- **Version**: 2.16
- **Components**: 14
- **Source**: checkouts/red-hat-data-services.rhoai-2.16
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.16
```
