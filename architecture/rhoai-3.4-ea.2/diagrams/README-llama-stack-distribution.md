# Architecture Diagrams for Llama Stack Distribution

Generated from: `architecture/rhoai-3.4-ea.2/llama-stack-distribution.md`
...
```bash
/generate-architecture-diagrams --architecture=../llama-stack-distribution.md
```
