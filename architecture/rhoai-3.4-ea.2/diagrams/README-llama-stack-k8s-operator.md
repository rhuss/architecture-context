# Architecture Diagrams for Llama Stack K8s Operator

Generated from: `architecture/rhoai-3.4-ea.2/llama-stack-k8s-operator.md`
...
```bash
/generate-architecture-diagrams --architecture=architecture/rhoai-3.4-ea.2/llama-stack-k8s-operator.md
```
