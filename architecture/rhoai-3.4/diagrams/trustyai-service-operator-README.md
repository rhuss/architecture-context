...
Generated from: `architecture/rhoai-3.4/trustyai-service-operator.md`
...
### For Developers
- [Component Structure](./trustyai-service-operator-component.png) ([mmd](./trustyai-service-operator-component.mmd)) - Mermaid diagram showing internal components (6 controllers, CRDs, created resources)
- [Data Flows](./trustyai-service-operator-dataflow.png) ([mmd](./trustyai-service-operator-dataflow.mmd)) - Sequence diagram of all 4 request/response flows (TAS, LMEval, Guardrails, EvalHub)
- [Dependencies](./trustyai-service-operator-dependencies.png) ([mmd](./trustyai-service-operator-dependencies.mmd)) - Component dependency graph (KServe, Kueue, Istio, etc.)
