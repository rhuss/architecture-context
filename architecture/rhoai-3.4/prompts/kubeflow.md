...
This means the kustomization.yaml the operator actually processes is at:
  components/odh-notebook-controller/config/rhoai/overlays/additional/kustomization.yaml
...
kustomization.yaml at components/odh-notebook-controller/config/rhoai/overlays/additional/ rather than the base. The overlay
