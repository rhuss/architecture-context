...
The operator applies the following overlay for RHOAI self-managed: rhoai/overlays/additional

Overlay path within source_folder: rhoai/overlays/additional
...
All overlay paths by platform/name:
  notebookImagesManifestSourcePath:SelfManagedRhoai: rhoai/overlays/additional
  notebookImagesManifestSourcePath:ManagedRhoai: rhoai/overlays/additional
  notebookImagesManifestSourcePath:OpenDataHub: odh/overlays/additional
  notebookImagesParamsPath:SelfManagedRhoai: rhoai/base
  notebookImagesParamsPath:ManagedRhoai: rhoai/base
  notebookImagesParamsPath:OpenDataHub: odh/base
  notebookControllerManifestSourcePath: base
  kfNotebookControllerManifestSourcePath: overlays/openshift

params.env values (from prefetched-manifests/workbenches/notebooks/rhoai/base/params.env):
...
kustomization.yaml at manifests/rhoai/overlays/additional/ rather than the base. The overlay
