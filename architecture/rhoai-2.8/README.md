# RHOAI 2.8 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.8
Platform version from: checkouts/red-hat-data-services.rhoai-2.8/rhods-operator
Date: 2026-03-15
...
- **Version**: 2.8
- **Components**: 12
- **Source**: checkouts/red-hat-data-services.rhoai-2.8
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.8
```
