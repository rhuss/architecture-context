...
Generated from: `architecture/rhoai-3.2/openvino_model_server.md`
...
```bash
/generate-architecture-diagrams --architecture=architecture/rhoai-3.2/openvino_model_server.md
```
