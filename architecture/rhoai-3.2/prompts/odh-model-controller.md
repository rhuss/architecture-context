...
params.env values (from prefetched-manifests/modelcontroller/base/params.env):
  ...
  tgis-image=quay.io/opendatahub/text-generation-inference:stable-0e348ab
  ...
  vllm-gaudi-image=quay.io/opendatahub/vllm:gaudi-1.19.0-6822bb3
  vllm-rocm-image=quay.io/opendatahub/vllm:stable-rocm-5a42fad
  vllm-spyre-x86-image=quay.io/opendatahub/vllm:fast-spyre-x86
  vllm-spyre-s390x-image=quay.io/opendatahub/vllm:fast-spyre-s390x
