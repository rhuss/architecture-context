# RHOAI 2.17 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.17
Platform version from: checkouts/red-hat-data-services.rhoai-2.17/rhods-operator
Date: 2026-03-16
...
- **Version**: 2.17
- **Components**: 14
- **Source**: checkouts/red-hat-data-services.rhoai-2.17
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.17
```
