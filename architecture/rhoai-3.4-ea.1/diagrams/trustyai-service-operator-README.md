...
Generated from: `architecture/rhoai-3.4-ea.1/trustyai-service-operator.md`
...
### For Developers
- [Component Structure](./trustyai-service-operator-component.png) ([mmd](./trustyai-service-operator-component.mmd)) - Mermaid diagram showing internal components (5 controllers, CRDs, created resources)
- [Data Flows](./trustyai-service-operator-dataflow.png) ([mmd](./trustyai-service-operator-dataflow.mmd)) - Sequence diagram of TrustyAI Service deployment, LM Eval job execution, and Guardrails orchestration flows
