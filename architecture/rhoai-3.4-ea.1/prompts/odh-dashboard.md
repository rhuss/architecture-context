...
The operator applies the following overlay for RHOAI self-managed: rhoai/onprem

Overlay path within source_folder: rhoai/onprem
...
All overlay paths by platform/name:
  overlaysSourcePaths:SelfManagedRhoai: rhoai/onprem
  overlaysSourcePaths:ManagedRhoai: rhoai/addon
  overlaysSourcePaths:OpenDataHub: odh
  observabilitySourcePaths:SelfManagedRhoai: observability/rhoai
  observabilitySourcePaths:ManagedRhoai: observability/rhoai
  observabilitySourcePaths:OpenDataHub: observability/odh
...
params.env values (from prefetched-manifests/dashboard/rhoai/onprem/params.env):
...
Computed kustomize variables:
  ...
  sectionTitle:ManagedRhoai: OpenShift Managed Services
...
kustomization.yaml at manifests/rhoai/onprem/ rather than the base. The overlay
