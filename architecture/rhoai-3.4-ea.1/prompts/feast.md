...
params.env values (from prefetched-manifests/feastoperator/overlays/rhoai/params.env):
  RELATED_IMAGE_FEAST_OPERATOR=quay.io/feastdev/feast-operator:0.60.0
  RELATED_IMAGE_FEATURE_SERVER=quay.io/feastdev/feature-server:0.60.0
...
kustomization.yaml at infra/feast-operator/config/overlays/rhoai/ rather than the base. The overlay
