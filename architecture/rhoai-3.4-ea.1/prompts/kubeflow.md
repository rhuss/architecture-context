...
params.env values (from prefetched-manifests/workbenches/odh-notebook-controller/base/params.env):
...
kustomization.yaml at components/odh-notebook-controller/config/overlays/additional/ rather than the base. The overlay
