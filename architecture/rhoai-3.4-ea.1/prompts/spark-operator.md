...
All overlay paths by platform/name:
  ManifestsSourcePath:SelfManagedRhoai: overlays/rhoai
  ManifestsSourcePath:ManagedRhoai: overlays/rhoai
  ManifestsSourcePath:OpenDataHub: overlays/odh
...
params.env values (from prefetched-manifests/sparkoperator/overlays/rhoai/params.env):
  RELATED_IMAGE_SPARK_OPERATOR_IMAGE=quay.io/opendatahub/spark-operator:v2.4.0
  OPERATOR_VERSION=2.4.0
  SPARK_OPERATOR_CONTROLLER_IMAGE=quay.io/opendatahub/spark-operator:v2.4.0
  SPARK_OPERATOR_WEBHOOK_IMAGE=quay.io/opendatahub/spark-operator:v2.4.0
  OPERATOR_NAMESPACE=redhat-ods-applications
