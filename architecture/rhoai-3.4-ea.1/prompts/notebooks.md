...
Total shipped container images: 84
...
Source repositories producing container images (43 repos -> 84 images):
  MLServer: 1 image(s)
  NeMo-Guardrails: 1 image(s)
  RHOAI-Build-Config: 1 image(s)
  argo-workflows: 2 image(s)
  data-science-pipelines: 5 image(s)
  data-science-pipelines-operator: 1 image(s)
  distributed-workloads: 8 image(s)
  eval-hub: 1 image(s)
  feast: 2 image(s)
  fms-guardrails-orchestrator: 1 image(s)
  guardrails-detectors: 2 image(s)
  kserve: 4 image(s)
  kube-auth-proxy: 1 image(s)
  kubeflow: 2 image(s)
  kuberay: 1 image(s)
  llama-stack-distribution: 1 image(s)
  llama-stack-k8s-operator: 1 image(s)
  llama-stack-provider-trustyai-garak: 1 image(s)
  llm-d-inference-scheduler: 2 image(s)
  lm-evaluation-harness: 1 image(s)
  ml-metadata: 1 image(s)
  mlflow: 1 image(s)
  mlflow-operator: 1 image(s)
  model-metadata-collection: 1 image(s)
  model-registry: 2 image(s)
  model-registry-operator: 1 image(s)
  models-as-a-service: 1 image(s)
  models-perf-benchmark-data: 1 image(s)
  must-gather: 1 image(s)
  notebooks: 18 image(s)
  odh-cli: 1 image(s)
  odh-dashboard: 4 image(s)
  odh-model-controller: 1 image(s)
  openvino_model_server: 1 image(s)
  rhods-operator: 1 image(s)
  spark-operator: 1 image(s)
  trainer: 1 image(s)
  training-operator: 1 image(s)
  trustyai-explainability: 1 image(s)
  trustyai-service-operator: 2 image(s)
  vllm-cpu: 1 image(s)
  vllm-gaudi: 1 image(s)
  vllm-orchestrator-gateway: 1 image(s)
...
params.env values (from prefetched-manifests/workbenches/notebooks/base/params.env):
  ...
  odh-workbench-jupyter-datascience-cpu-py312-ubi9-2025-2=registry.redhat.io/rhoai/odh-workbench-jupyter-datascience-cpu-py312-rhel9@sha256:941287462ca9bf5f692346cd6c10135962e3a2bc7bb5f1ad58b25487ed05edf1
  odh-workbench-jupyter-pytorch-cuda-py312-ubi9-2025-2=registry.redhat.io/rhoai/odh-workbench-jupyter-pytorch-cuda-py312-rhel9@sha256:a73219bf01b74d62d7a096652274da08b5101d7911ba1d50319d663b63746ddc
  odh-workbench-jupyter-pytorch-rocm-py312-ubi9-2025-2=registry.redhat.io/rhoai/odh-workbench-jupyter-pytorch-rocm-py312-rhel9@sha256:f25e91832ff82afd84c67440317525c9169c62a0e6789032ac4f8ddb4995afac
  odh-workbench-jupyter-tensorflow-cuda-py312-ubi9-2025-2=registry.redhat.io/rhoai/odh-workbench-jupyter-tensorflow-cuda-py312-rhel9@sha256:8036dd68f3c12b17cd6fe5cd2a37462541328b49e1d8fa086e2c114dc5f2e11c
  odh-workbench-jupyter-tensorflow-rocm-py312-ubi9-2025-2=registry.redhat.io/rhoai/odh-workbench-jupyter-tensorflow-rocm-py312-rhel9@sha256:8cfa6fb16d6121743f58157bdebce11e1a7e95410b732fef7b8034b70efc95a5
  odh-workbench-jupyter-trustyai-cpu-py312-ubi9-2025-2=registry.redhat.io/rhoai/odh-workbench-jupyter-trustyai-cpu-py312-rhel9@sha256:33c5f1f41404cb9b493cc69197f6faef23da54dcab2d292775fe37f6eaae6852
  ...
  odh-workbench-jupyter-pytorch-rocm-py311-ubi9-2025-1=registry.redhat.io/rhoai/odh-workbench-jupyter-pytorch-rocm-py311-rhel9@sha256:8270d5c58389d0f7ed086336c730060c3792453a4ddc08f0bc622677edd3e0fd
  odh-workbench-jupyter-pytorch-rocm-py311-ubi9-2024-2=quay.io/modh/rocm-notebooks@sha256:1f0b19b7ae587d638e78697c67f1290d044e48bfecccfb72d7a16faeba13f980
  odh-workbench-jupyter-tensorflow-rocm-py311-ubi9-2025-1=registry.redhat.io/rhoai/odh-workbench-jupyter-tensorflow-rocm-py311-rhel9@sha256:4d1b945221fe7f3e7a486277f27529b9ba2b73b03b9a7e2a3382c133671fcff3
  odh-workbench-jupyter-tensorflow-rocm-py311-ubi9-2024-2=quay.io/modh/rocm-notebooks@sha256:f94702219419e651327636b390d1872c58fd7b8f9f6b16a02c958ffb918eded3
