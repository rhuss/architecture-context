...
The operator applies the following overlay for RHOAI self-managed: overlays/rhoai

Overlay path within source_folder: overlays/rhoai
...
All overlay paths by platform/name:
  overlaysSourcePaths:SelfManagedRhoai: overlays/rhoai
  overlaysSourcePaths:ManagedRhoai: overlays/rhoai
  overlaysSourcePaths:OpenDataHub: overlays/odh
...
params.env values (from prefetched-manifests/datasciencepipelines/base/params.env):
...
kustomization.yaml at config/overlays/rhoai/ rather than the base. The overlay
