...
The operator applies the following overlay for RHOAI self-managed: rhoai

Overlay path within source_folder: rhoai
...
params.env values (from prefetched-manifests/trainer/rhoai/params.env):
  odh-kubeflow-trainer-controller-image=quay.io/opendatahub/trainer:v2.1.0
  odh-training-cuda128-torch29-py312-image=quay.io/opendatahub/odh-training-cuda128-torch29-py312@sha256:8e34bce95ad21258bdb337d72dc1565ea8f949a101c979076f7e65f335baea2d
  odh-training-rocm64-torch29-py312-image=quay.io/opendatahub/odh-training-rocm64-torch29-py312@sha256:76a88281fe9465115d48803b05435cfb48b9d0e6b279b6575d9c9dbb6e4e1908

IMPORTANT: When analyzing this component's kustomize manifests, start from the overlay
kustomization.yaml at manifests/rhoai/ rather than the base. The overlay
