# RHOAI 2.14 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.14
Platform version from: checkouts/red-hat-data-services.rhoai-2.14/rhods-operator
Date: 2026-03-15
...
- **Version**: 2.14
- **Components**: 14
- **Source**: checkouts/red-hat-data-services.rhoai-2.14
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.14
```
