# RHOAI 2.13 - Component Architectures

Generated from: checkouts/red-hat-data-services.rhoai-2.13
Platform version from: checkouts/red-hat-data-services.rhoai-2.13/rhods-operator
Date: 2026-03-15
...
- **Version**: 2.13
- **Components**: 13
- **Source**: checkouts/red-hat-data-services.rhoai-2.13
...
```bash
/aggregate-platform-architecture --distribution=rhoai --version=2.13
```
